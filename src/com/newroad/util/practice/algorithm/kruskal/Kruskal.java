package com.newroad.util.practice.algorithm.kruskal;
...
import com.newroad.util.practice.algorithm.common.UnionFind;
...
public final class Kruskal {
     ...
     */
    private static <T> List<Edge<T>> getEdges(UndirectedMapGraph<T> graph) {
