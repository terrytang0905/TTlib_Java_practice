...
public final class TopologicalSort {
     ...
     */
    public static <T> List<T> sort(DirectedSetGraph<T> g) {
        /* Construct the reverse graph from the input graph. */
    	DirectedSetGraph<T> gRev = reverseGraph(g);
     ...
     */
    private static <T> void explore(T node, DirectedSetGraph<T> g,
     ...
     */
    private static <T> DirectedSetGraph<T> reverseGraph(DirectedSetGraph<T> g) {
