package com.newroad.util.practice.algorithm.dynamicprogramming;

/**
 * Created by zhenjie.tang on 2019-06-08.
 */
public class StateTransfer {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(StateTransfer.getStrDistance("mouse", "mouuse"));
