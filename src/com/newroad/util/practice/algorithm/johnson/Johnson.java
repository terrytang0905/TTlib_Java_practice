package com.newroad.util.practice.algorithm.johnson;
...
import com.newroad.util.practice.algorithm.bellmanford.BellmanFord;
import com.newroad.util.practice.algorithm.common.DirectedMapGraph;
import com.newroad.util.practice.algorithm.dijkstra.Dijkstra;
...
public final class Johnson {
     ...
     *         graph.
     */
    public static <T> DirectedMapGraph<T> shortestPaths(DirectedMapGraph<T> graph) {
         ...
         */
        DirectedMapGraph<Object> augmentedGraph = constructAugmentedGraph(graph);
         ...
         */
        DirectedMapGraph<T> reweightedGraph = reweightGraph(graph, potential);
         ...
         */
        DirectedMapGraph<T> result = new DirectedMapGraph<T>();
        for (T node: graph)
            result.addNode(node);
     ...
     */
    private static <T> DirectedMapGraph<Object> constructAugmentedGraph(DirectedMapGraph<T> graph) {
        DirectedMapGraph<Object> result = new DirectedMapGraph<Object>();
     ...
     */
    private static <T> DirectedMapGraph<T> reweightGraph(DirectedMapGraph<T> graph,
