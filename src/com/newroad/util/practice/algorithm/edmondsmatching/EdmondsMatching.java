package com.newroad.util.practice.algorithm.edmondsmatching;
...
import com.newroad.util.practice.algorithm.common.UndirectedSetGraph;
...
public final class EdmondsMatching {
     ...
     */
    private static <T> void updateMatching(List<T> path, UndirectedSetGraph<T> m) {
     ...
     */
    private static <T> List<T> findAlternatingPath(UndirectedSetGraph<T> g,
                                                   UndirectedSetGraph<T> m) {
     ...
     */
    private static <T> UndirectedSetGraph<T> contractGraph(UndirectedSetGraph<T> g,
                                                        Blossom<T> blossom) {
     ...
     *         node.
     */
    private static <T> T findNodeLeavingCycle(UndirectedSetGraph<T> g,
                                              Blossom<T> blossom,
                                              T node) {
