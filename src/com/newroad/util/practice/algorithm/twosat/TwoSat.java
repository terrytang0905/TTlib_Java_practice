package com.newroad.util.practice.algorithm.twosat;
...
import com.newroad.util.practice.algorithm.common.Clause;
import com.newroad.util.practice.algorithm.common.DirectedSetGraph;
import com.newroad.util.practice.algorithm.common.Literal;
import com.newroad.util.practice.algorithm.kosaraju.Kosaraju;
...
public final class TwoSat {
    ...
    public static <T> boolean isSatisfiable(List<Clause<T>> formula) {
         ...
         * nodes.
         */
        DirectedSetGraph<Literal<T>> implications = new DirectedSetGraph<Literal<T>>();
