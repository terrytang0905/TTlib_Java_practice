package com.newroad.util.practice.algorithm.bipartiteverify;
...
public final class BipartiteVerify {
     ...
     */
    public static <T> boolean isBipartite(UndirectedSetGraph<T> g) {
     ...
     */
    private static <T> boolean dfsExplore(T node, UndirectedSetGraph<T> g,
