package com.newroad.util.practice.algorithm.floydwarshall;
...
public final class FloydWarshall {
     ...
     */
    private static <T> Map<T, Integer> enumerateNodes(DirectedMapGraph<T> graph) {
     ...
     */
    @SuppressWarnings("unchecked")
    private static <T> DirectedMapGraph<T> distancesToGraph(double[][] values,
