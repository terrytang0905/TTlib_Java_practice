package com.newroad.util.practice.algorithm.prim;
...
import com.newroad.util.practice.algorithm.common.FibonacciHeap;
import com.newroad.util.practice.algorithm.common.UndirectedMapGraph;
...
public final class Prim {
     ...
     */
    public static <T> UndirectedMapGraph<T> mst(UndirectedMapGraph<T> graph) {
        ...
        UndirectedMapGraph<T> result = new UndirectedMapGraph<T>();
     ...
     *               so far.
     */
    private static <T> T minCostEndpoint(T node, UndirectedMapGraph<T> graph, 
                                         UndirectedMapGraph<T> result) {
     ...
     *                elements.
     */
    private static <T> void addOutgoingEdges(T node, UndirectedMapGraph<T> graph,
                                             FibonacciHeap<T> pq,
                                             UndirectedMapGraph<T> result,
