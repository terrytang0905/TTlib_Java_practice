package com.newroad.util.practice.algorithm.kosaraju;
...
import com.newroad.util.practice.algorithm.common.DirectedSetGraph;
...
public final class Kosaraju {
     ...
     */
    public static <T> Map<T, Integer> stronglyConnectedComponents(DirectedSetGraph<T> g) {
     ...
     */
    private static <T> DirectedSetGraph<T> graphReverse(DirectedSetGraph<T> g) {
    	DirectedSetGraph<T> result = new DirectedSetGraph<T>();
     ...
     *         exploring them.
     */
    private static <T> Stack<T> dfsVisitOrder(DirectedSetGraph<T> g) {
     ...
     */
    private static <T> void recExplore(T node, DirectedSetGraph<T> g,
     ...
     */
    private static <T> void markReachableNodes(T node, DirectedSetGraph<T> g,
